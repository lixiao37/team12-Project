...
class TestGetMetaData(unittest.TestCase):
	...
	def setUp(self):
		...
		self.meta_data_one = {'author': 'Al Jazeera and agencies', 
		                 'url': 'http://www.aljazeera.com/news/middleeast/2014/11/syria-seriously-studying-un-truce-proposal-2014111118514613822.html',
		                 'title': "Syria 'seriously studying' UN truce proposal"
		                 }
